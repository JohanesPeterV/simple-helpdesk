...
async function loginBinusian(username: string, password: string, res: NextApiResponse, req: NextApiRequest) {
...
async function adminLogin(admin: Admin, password: string, res: NextApiResponse, req: NextApiRequest) {
