            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div className="mt-1 sm:mt-0 sm:col-span-2">
                <textarea
                  ...
                  className="max-w-lg border-2 shadow-sm block w-full sm:text-sm border-gray-300 rounded-md py-2 px-2 hover:shadow-md focus:shadow-md focus:ring-0 focus:outline-none focus:border-slate-400"
                  defaultValue={''}
                />
