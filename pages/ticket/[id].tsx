...
import {PaperClipIcon, QuestionMarkCircleIcon} from "@heroicons/react/solid";
...
export const getServerSideProps = withIronSessionSsr(
    async function getServerSideProps({req, query}) {
        ...
        return {
            props: req.session.user && query.id ? {
                ticket: await TicketController.get(req.session.user, query.id.toString())
            } : {},
        }
    },
    ironSessionOptions
